...
const INSTAGRAM_URL = "https://www.instagram.com/ecs.sanchez.cix";
const CONTACT_EMAIL = "ecs.sanchez.chiclayo@gmail.com"
...
// Componente SVG nativo para el ícono de Instagram
      ...
      <footer id="contacto" className="bg-[#0D1831] text-slate-300 relative pt-16 pb-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-slate-800">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl overflow-hidden flex items-center justify-center shadow-md shrink-0">
                  <img
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <li className="flex items-start space-x-3 text-slate-400">
                  <Mail className="w-5 h-5 text-[#A61F1F] shrink-0 mt-0.5" />
                  <a 
                ...
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-[#E1306C] text-white flex items-center justify-center transition-all duration-300 shadow-sm"
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4 text-center sm:text-left">
            ...
            {/* Firma de SOLVEX con enlace a WhatsApp */}
            <p className="text-slate-500">
              Desarrollado por{" "}
              <a
                href="https://wa.me/51974758561?text=Hola%20SOLVEX,%20estoy%20interesado%20en%20que%20me%20desarrollen%20una%20p%C3%A1gina%20web%20similar%20a%20la%20del%20Estudio%20Contable."
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-300 font-bold hover:text-[#25D366] transition-colors duration-300"
                aria-label="Contactar a SOLVEX por WhatsApp"
              >
                SOLVEX
              </a>
              , derechos reservados, contacto:{" "}
              <a
                href="https://wa.me/51974758561?text=Hola%20SOLVEX,%20estoy%20interesado%20en%20que%20me%20desarrollen%20una%20p%C3%A1gina%20web%20similar%20a%20la%20del%20Estudio%20Contable."
                target="_blank"
                rel="noopener noreferrer"
